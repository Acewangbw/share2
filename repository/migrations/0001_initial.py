# Generated by Django 2.0 on 2019-02-11 19:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=0, max_length=1, verbose_name='文件是否可以发布')),
        ...
        migrations.AddField(
            ...
            name='department',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Dep'),
        ),
        migrations.AddField(
            model_name='addfilemodel',
