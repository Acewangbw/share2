...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            # print("-" * 50)
            # 用户名查重
            if UserInfo.objects.filter(email=user_email):
                return render(
                    request, "register.html", {
            ...
            # user_profile.username = User.objects.create(username=user_name)
            # user_profile.password = User.objects.create(password=pass_word)
            user_profile.email = user_email
            ...
            # print(user_profile.set_password(pass_word))
