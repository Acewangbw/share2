...
# 导入setting中发送邮件的配置
from share2.settings import EMAIL_FROM
# 发送html格式的邮件:
...
def send_register_eamil(email, send_type="register"):
    ...
    if send_type == "register":
        email_title = "Share2注册激活链接"
        email_body = "欢迎注册Share2:请点击下面的链接激活你的账号: http://127.0.0.1:8000/active/{0}".format(code)
